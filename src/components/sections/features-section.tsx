        ...
        >
          <div className="grid md:grid-cols-2 gap-12 md:gap-24 items-center">
            <div className={feature.layout === 'left' ? "order-1" : "order-1 md:order-2"}>
              <div className="relative aspect-[4/3] w-full bg-slate-900 rounded-[2rem] md:rounded-[3rem] overflow-hidden border border-white/5 group shadow-xl shadow-purple-500/5 backdrop-blur-3xl">
                <Image
            ...
            <div className={feature.layout === 'left' ? "order-2 space-y-8" : "order-2 md:order-1 space-y-8"}>
              <div className="space-y-4">
                <span className="text-white/40 font-bold text-[10px] uppercase tracking-[0.5em] border border-white/10 bg-white/5 px-4 py-1.5 rounded-full inline-block">
