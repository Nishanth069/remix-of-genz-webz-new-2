          ...
          >
            <div className="grid md:grid-cols-2 gap-12 md:gap-24 items-center">
              <div className={feature.layout === 'left' ? "order-1" : "order-1 md:order-2"}>
                <div className="relative aspect-[4/3] w-full bg-slate-900 rounded-[2rem] md:rounded-[3rem] overflow-hidden border border-purple-500/10 group shadow-xl shadow-purple-500/5 backdrop-blur-3xl transition-colors group-hover/feature:border-purple-500/20">
                  <Image
              ...
              <div className={feature.layout === 'left' ? "order-2 space-y-8" : "order-2 md:order-1 space-y-8"}>
                <div className="space-y-4">
                  <span className="text-purple-400 font-bold text-[10px] uppercase tracking-[0.5em] border border-purple-500/20 bg-purple-500/5 px-4 py-1.5 rounded-full inline-block">
                    Phase 0{index + 1} / {feature.label}
                  </span>
                  <h3 className="text-4xl md:text-5xl font-bold text-white tracking-tighter leading-[1]">{feature.title}</h3>
                </div>
                <p className="text-white/40 text-lg leading-relaxed font-light tracking-tight max-w-xl">{feature.description}</p>
                <div className="pt-4">
