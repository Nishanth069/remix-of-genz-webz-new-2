    ...
    return () => {
      document.body.style.overflow = "unset";
        ...
        const projects: Project[] = [
          { id: 1, title: "Aura Intelligence", width: "w-[400px]", preview: "/previews/aura.mp4", thumbnail: "/previews/aurat.png" },
          { id: 2, title: "Aroma Digital",  width: "w-[320px]", preview: "/previews/aroma.mp4", thumbnail: "/previews/aromat.png" },
          { id: 3, title: "Argus Analytics", width: "w-[380px]", preview: "/previews/argus.mp4", thumbnail: "/previews/argust.png" },
          { id: 4, title: "Lumina Core", width: "w-[350px]", preview: "/previews/lumina.mp4", thumbnail: "/previews/luminat.png" },
          { id: 5, title: "SpaceFlux Web", width: "w-[420px]", preview: "/previews/spaceflux.mp4", thumbnail: "/previews/spacefluxt.png" },
        ];
                ...
                >
                    ...
                    >
                      <Image
                        ...
                        fill
                        className={`object-cover transition-opacity duration-200 ${isPlaying ? "opacity-0" : "opacity-100"}`}
