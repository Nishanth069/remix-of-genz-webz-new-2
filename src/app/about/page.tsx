    ...
    <SmoothTransitionsProvider>
      <div className="min-h-screen bg-black text-white antialiased selection:bg-purple-500 selection:text-white">
        ...
        <main>
                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                  ...
                  >
                    ...
                    <div className="space-y-6 text-white/40 text-lg md:text-xl font-light leading-relaxed">
                      ...
                      <p>
                        We saw a gap between <span className="text-white font-medium">raw power</span> and <span className="text-white/60 font-medium">human elegance</span>. Most software was either fast but ugly, or beautiful but broken. We set out to bridge that void.
                      </p>
                    </div>
                  </motion.div>
                  ...
                  <motion.div 
                    ...
                    className="relative aspect-square rounded-[2rem] overflow-hidden border border-white/5 group shadow-2xl shadow-purple-500/5"
                  >
                    <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1635070041078-e363dbe005cb?q=80&w=1600&auto=format&fit=crop')] bg-cover bg-center transition-transform duration-[3s] group-hover:scale-105 opacity-60" />
                    ...
                    <div className="absolute bottom-8 left-8 right-8 p-6 bg-black/40 backdrop-blur-md rounded-2xl border border-white/5">
                      <p className="text-[10px] uppercase tracking-[0.5em] text-white/60 mb-3 font-bold">The Core Belief</p>
                      <h3 className="text-2xl font-bold tracking-tight text-white leading-tight">"Efficiency is the foundation, but elegance is the standard."</h3>
                    </div>
                  </motion.div>
                </div>
              </div>
            ...
            {/* Philosophy Pillars */}
            <section className="py-24 border-y border-white/5 bg-slate-950/20">
              <div className="max-w-7xl mx-auto px-6">
                <div className="text-center mb-16 space-y-4">
                   <h2 className="text-4xl md:text-6xl font-bold tracking-tighter text-white">OUR PILLARS.</h2>
                   <p className="text-white/20 uppercase tracking-[0.4em] text-[10px] font-bold">The DNA of Zyxen Engineering</p>
                </div>
                <div className="grid md:grid-cols-3 gap-8">
                  {[
                    {
                      icon: <Cpu className="text-white/60" size={28} />,
                    ...
                    {
                      icon: <Eye className="text-white/60" size={28} />,
                    ...
                    {
                      icon: <Zap className="text-white/60" size={28} />,
